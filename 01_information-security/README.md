...
- ДБыла нарушена конфиденциальность информации, потому что в руках злоумышленника оказались ФИО и номера телефонов клиентов. 
- Была нарушена доступность информации, потому что злоумышленники получили доступ в интернет-банк с учётными данными клиента банака. 
- Целостность информации не пострадала, так как попытка перевода средств на собственные счета (с карты клиента на счета злоумышленника) была заблокирована системой, при этом карта и учётная запись клиента остались функционирующими

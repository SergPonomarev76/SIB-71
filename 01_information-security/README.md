# Домашнее задание к занятию «1.1. Информационная безопасность: введение в специальность» - Пономарёв Сергей Валентинович
...
## Ответ №1
1. На основании Статьи 23 п.2 Конституции РФ "Ограничение права на тайну переписки или телефонных переговоров допускается только на основании судебного решения."
2. На основании Статьи 55 п.3 Конституции РФ "Права и свободы человека и гражданина могут быть ограничены федеральным законом только в той мере, в какой это необходимо в целях защиты основ конституционного строя, нравственности, здоровья, прав и законных интересов других лиц, обеспечения обороны страны и безопасности государства."
...
2. Предоставление - ограниченный круг лиц
Распространение - неограниченный круг лиц получает доступ
3. ИБ (информационная безопасность) – состояние защищенности информации, при котором обеспечены её конфиденциальность, доступность и целостность.
Информация не должна передаваться без разрешения владельца, должен быть ограничен доступ к ней других лиц, целостность не должна изменяться несанционированным образом. 
...
- Была нарушена конфиденциальность информации, потому что в руках злоумышленника оказались ФИО и номера телефонов клиентов. 
- Не была нарушена доступность информации, Клиент сохранил доступ к своему интернет-банку, карте и счёту — система не заблокировала их.
- Была нашена целостность информации, злоумышленник получил легальные (с точки зрения системы) учётные данные клиента и вошёл в интернет-банк. Система не смогла на этапе входа отличить его от настоящего владельца — значит, механизм защиты целостности (который должен гарантировать, что к данным получает доступ только авторизованный пользователь) дал сбой. Попытка перевода средств — это уже действие, меняющее состояние системы (целостность финансовых данных), которое злоумышленник инициировал, обойдя защиту.
## Критерии оценки
